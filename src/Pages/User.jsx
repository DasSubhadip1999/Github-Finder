...
import RepoList from '../Components/UI_Design/RepoList';

function User() {
    const {user, getUser, getUserRepos, repos} = useContext(UserDataContext);
                ...
                <div className='col-span-2'>
                    <div className='mb-6'>
                        ...
                        <div className='mt-4 card-actions'>
                            <a className='btn btn-outline' href={html_url} rel='noreferrer' target='_blank'>Visit Profile</a>
                        </div>
                    </div>
